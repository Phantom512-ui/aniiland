...
The hosted site is designed as a static application and can be deployed directly to Vercel, GitHub Pages, or any ordinary static host.
...
Original Aniiland source code is available under the **MIT License**; see `LICENSE`.
